...
class ConfirmationEvaluation(models.Model):
    ...
    confirmation_done_by_id = fields.Many2one('hr.employee', string="Confirmation commendation done by")
    job_position_id = fields.Many2one('hr.job', string="Designation")
    ...
    hod_id = fields.Many2one('hr.employee', string="COMMENTS VERIFIED BY HOD")
    ...
    hr_executive_id = fields.Many2one('hr.employee', string="HR Executive")
    executive_director_id = fields.Many2one('hr.employee', string="Executive Director")
